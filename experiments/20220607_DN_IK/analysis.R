...
data_stats <- data_summary(data_analysis_corrected, varname = c("OD_corrected"),
                                          groupnames = c("Time", "Strain", "State", "Trehalose", "Condition"))
...
ggsave("20220607_DN_IK_SD_HIS_LEU.pdf")